    ...
    <div className="row-span-1">
      <div className="w-full h-full flex items-center justify-center">
        <motion.div
          ...
          className="hover:cursor-pointer relative w-[70%] sm:w-[55%] h-[70%] border-4 border-page4 hover:border-pageMenu rounded-xl flex items-center justify-center bg-page2 hover:bg-page4 shadow-2xl"
        >
