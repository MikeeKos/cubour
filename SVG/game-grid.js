...
const controllerSVG = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="w-52 h-52 md:w-96 md:h-96 fill-pageMenu"
    viewBox="0 0 16 16"
  >
...
const keyboardSVG = (
  <svg
    ...
    fill="none"
    viewBox="0 0 24 24"
    className="w-[2rem] h-[2rem] align-middle"
  >
    <path
      className="stroke-page1"
      stroke="#000"
      ...
      strokeLinejoin="round"
      strokeWidth="2.5"
      d="M6 13h.01M6 17h.01M10 13h.01M14 13h.01M18 17h.01M18 13h.01M16 3v2H8v4m2 8h4m-8.8 4h13.6c1.12 0 1.68 0 2.108-.218a2 2 0 00.874-.874C22 19.48 22 18.92 22 17.8v-5.6c0-1.12 0-1.68-.218-2.108a2 2 0 00-.874-.874C20.48 9 19.92 9 18.8 9H5.2c-1.12 0-1.68 0-2.108.218a2 2 0 00-.874.874C2 10.52 2 11.08 2 12.2v5.6c0 1.12 0 1.68.218 2.108a2 2 0 00.874.874C3.52 21 4.08 21 5.2 21z"
    ></path>
  </svg>
);
...
const lightningSVG = (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2.5"
      d="M13 3l-7.931 9.693c-.342.418-.513.627-.514.803a.5.5 0 00.186.394c.138.11.407.11.947.11H12l-1 7 7.93-9.693c.342-.418.513-.627.514-.803a.5.5 0 00-.186-.394C19.12 10 18.85 10 18.31 10H12l1-7z"
    ></path>
  </svg>
);
